...
extern "system" {
    ...
    pub fn DirectSoundEnumerateA(pDSEnumCallback: LPDSENUMCALLBACKA, pContext: LPVOID) -> HRESULT;
    pub fn DirectSoundEnumerateW(pDSEnumCallback: LPDSENUMCALLBACKW, pContext: LPVOID) -> HRESULT;
